...
for j,instr in enumerate(inp):
    ...
    if   i=='F':
        ...
        if   i==0:
            ...
            waypoint = (x-n,y)
    #print(f"coords={coords}, waypoint={waypoint}", end='\n')


print( sum([abs(each) for each in coords]) )

# 1 and > 265
# 2 25959 <ans < 52959, 56555
